...
\begin{figure}[h]
    ...
    \caption{Captura ilustrativa de una ejecución satisfactoria de la validación automatizada del sistema. La validación final del proyecto quedó cerrada con 29 pruebas superadas.}
