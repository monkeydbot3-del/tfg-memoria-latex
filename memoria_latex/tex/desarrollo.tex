...
La estructura final no responde ya a un prototipo anónimo y efímero, sino a una solución web modular con diferenciación de usuarios, persistencia selectiva y validación progresiva del aprendizaje. Esta organización general puede observarse en la Figura~\ref{fig:arquitectura-final}, donde se representa la relación entre presentación, control, lógica de negocio y persistencia.
