...
\subsection{Metodología asistida con Cocoliso/OpenClaw}

Durante la fase final del proyecto se utilizó un agente de asistencia al desarrollo integrado mediante OpenClaw. Su uso se mantuvo siempre bajo supervisión humana, actuando como apoyo para diagnóstico, documentación, propuestas de cambio, validación iterativa y organización del trabajo.

Desde el punto de vista metodológico, esto permitió acelerar tareas repetitivas y mantener trazabilidad sobre ramas, commits y validaciones, sin sustituir la toma de decisiones ni la responsabilidad técnica del desarrollo.
...
La validación de estas fases se realizó primero sobre la rama de vista previa y después sobre la rama principal, una vez confirmada su estabilidad.
