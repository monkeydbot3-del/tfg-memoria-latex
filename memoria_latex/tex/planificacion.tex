...
\subsection{Metodología asistida}

Durante la fase final del proyecto se utilizó asistencia al desarrollo integrada en el flujo de trabajo y sometida en todo momento a supervisión humana. Su papel se limitó al apoyo en tareas de diagnóstico, documentación, propuestas de cambio, validación iterativa y organización del trabajo.

Desde el punto de vista metodológico, este enfoque permitió acelerar tareas repetitivas y mantener trazabilidad sobre ramas, commits y validaciones, sin sustituir la toma de decisiones ni la responsabilidad técnica del desarrollo.
