...
El objetivo principal de este TFG es el diseño, desarrollo e implementación de una aplicación web robusta para el análisis fundamental de empresas y la simulación educativa de carteras de inversión, integrando datos de mercado reales, autenticación de usuarios, persistencia, validación automática de código y una experiencia de interfaz coherente.
...
\begin{itemize}
    ...
    \item \textbf{Gestión de usuarios y continuidad pedagógica:} Incorporar autenticación por correo, modo invitado, historial persistente para usuario registrado y mecanismos de progresión educativa como el readiness quiz, entendido como cuestionario previo de conocimientos, y el acceso escalonado al modo carrera.
\end{itemize}