...
\begin{itemize}
    ...
    \item \textbf{Gestión de usuarios y continuidad pedagógica:} Incorporar autenticación por correo, modo invitado, historial persistente para usuario registrado y mecanismos de progresión educativa como el readiness quiz y el acceso escalonado al modo carrera.
\end{itemize}